...
export function SpinnerIcon({ size = 12 }: { size?: number }) {
  return (
    <span
      ...
      className="border-portal-orange inline-block flex-shrink-0 animate-spin rounded-full border-2 border-t-transparent"
    />
  );
}

export function LinkIcon({ size = 10 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function DuplicateIcon({ size = 12 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function BookmarkIcon({ size = 12 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
